...
const initApiRoutes = (app) => {
    ...
    router.get("/resultReview/getResultsReviewByUserId", resultsReviewController.getResultsReviewByUserId);

    router.post("/upload-image", saveImageController.uploadAndRemoveBg);

    router.get("/image/:imageName", saveImageController.getImage);

    // Payment Transactioln 
    router.get("/paymentTransaction/getPaymentTransactionByUserId", paymentTransactionController.getPaymentTransactionByUserId);
