...
const getAllGroups = async () => {
    try {
        const sql = "select groupId, groupName, created_at as createdAt FROM `groups`";
...
const createNewGroup = async (rawData) => {
    try {
        ...
        const values = [rawData.groupName];
...
const updateGroup = async (rawData) => {
    try {
        ...
        const sql = "update `groups` set groupName = ? where groupId = ?";

        const values = [rawData.groupName, rawData.groupId];
