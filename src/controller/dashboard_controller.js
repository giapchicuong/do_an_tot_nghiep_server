...
const getAvgAndNumberOption = async (req, res) => {
    try {
        const data = await dashboardServices.getAvgAndNumberOption(req.body);
...
const getAvgStarAndTotalOptionByDate = async (req, res) => {
    try {
        const data = await dashboardServices.getAvgStarAndTotalOptionByDate(req.body);
